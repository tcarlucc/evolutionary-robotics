...
class SIMULATION:
    def __init__(self, directOrGUI, solutionID):
        ...
        p.resetDebugVisualizerCamera(cameraDistance=1, cameraYaw=0, cameraPitch=-10, cameraTargetPosition=[0, -5, 9])
    ...
    def Calculate_Drag(self, velocity_vector, linkIndex):
        ...
        if linkIndex == 0:
            ...
            return 0.5 * c.fluidDensity * 0.15 * c.dragCoefficient * velocity_vector ** 2
    ...
    def Calc_Displacement(self):
        ...
        self.totalDisplacement += np.sqrt(linkState[0][0] ** 2 + linkState[0][1] ** 2 + (10 - linkState[0][2]) ** 2)
